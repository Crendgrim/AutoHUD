...
public class AutoYacl<T> {
    ...
    protected static class Wrapper {
        protected final OptionGroup.Builder builder;
        protected final Object bDefaults;
        protected final Object bParent;
        protected final Map<String, OptionGroup.Builder> groups;
        protected final String modId;

        protected Wrapper(String modId, OptionGroup.Builder builder, Object bDefaults, Object bParent, Map<String, OptionGroup.Builder> groups) {
        ...
        OptionGroup.Builder getContainingBuilder(Field field) {
        ...
        protected void registerObject(OptionGroup.Builder containingBuilder, String key, Field field) {
        ...
        protected void register(String key, Field field) {
            OptionGroup.Builder containingBuilder = getContainingBuilder(field);
    ...
    public static class CategoryWrapper extends Wrapper {
        public CategoryWrapper(String modId, OptionGroup.Builder builder, Object bDefaults, Object bParent) {
            super(modId, builder, bDefaults, bParent, new HashMap<>());
        }

        private CategoryWrapper(String modId, OptionGroup.Builder builder, Object bDefaults, Object bParent, Map<String, OptionGroup.Builder> groups) {
            super(modId, builder, bDefaults, bParent, groups);
        }

        protected void registerObjectTransitively(OptionGroup.Builder containingBuilder, String key, Field field) {
            // register object transitively
            try {
    ...
    private static <T> CategoryWrapper wrapBuilder(String modId, String categoryName, T defaults, T config) {
        return new CategoryWrapper(
            modId,
            OptionGroup.createBuilder().name(Text.translatable(modId + ".category." + categoryName)),
            defaults,
            config);
    }
