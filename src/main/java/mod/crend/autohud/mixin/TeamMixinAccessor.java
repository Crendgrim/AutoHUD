...
public interface TeamMixinAccessor
{
	...
	/**
	 * Please do not use this method directly unless you're absolutely sure that
	 * the text being passed in the {@code prefix} parameter isn't {@code null}.
	...
	/**
	 * Please do not use this method directly unless you're absolutely sure that
	 * the text being passed in the {@code suffix} parameter isn't {@code null}.
