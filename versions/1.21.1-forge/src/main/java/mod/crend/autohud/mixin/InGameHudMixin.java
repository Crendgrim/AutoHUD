...
public abstract class InGameHudMixin {
	...
	private void autoHud$preActionBar(DrawContext context, RenderTickCounter tickCounter, CallbackInfo ci) {
	...
	private void autoHud$postActionBar(DrawContext context, RenderTickCounter tickCounter, CallbackInfo ci) {
